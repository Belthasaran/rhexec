...
Technique A: new SFC with reset trampoline plus WRAM/VRAM/CGRAM/OAM/ARAM payload. Re-enables NMI (`$4200`) and unblanks INIDISP. Does not patch `$05D89B`/`$05DCDD`. SA-1 and DSP envelopes are not restored.

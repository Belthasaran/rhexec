...
- `rhboot1-sfc` — embed WRAM/VRAM/CGRAM/OAM/ARAM after a reset trampoline; timed IPL to the captured SPC PC; restore INIDISP and `$4200` before jumping to the captured PC
